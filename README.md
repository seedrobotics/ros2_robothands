...
Please note that this version of the package has only been tested on Ubuntu 24.04.

In order to make this package work, you also need to have Python3 installed. This package have been developped using Python 3.12.3 (pre-installed in Ubuntu 24.04).
You also need to install the following python libs :
- rospy (should have been installed with ROS2 Jazzy)
- std_msgs (should have been installed with ROS2 Jazzy)
- pyserial
- numpy
...
source install/setup.*    (* Being your CLI, for example setup.bash)
